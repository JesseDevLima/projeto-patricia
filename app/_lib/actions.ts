...
export async function PUT(
  ...
  try {
    ...
    if (!existingTransportadora) {
      console.log("Transportadora não encontrada para atualização");
      return NextResponse.json(
    ...
    console.log("Transportadora atualizada:", transportadora);
    return NextResponse.json(transportadora, { status: 200 });
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    if (!existingTransportadora) {
      console.log("Transportadora não encontrada para exclusão");
      return NextResponse.json(
